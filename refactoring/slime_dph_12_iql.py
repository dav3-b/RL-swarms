...
import numpy as np
import random
from environments.slime_dph_12.slime_dph import Slime
...
def main(args):
    ...
    if args.render:
        from environments.slime_dph_12.slime_dph import SlimeVisualizer
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--params_path",
        type=str,
        default="environments/slime_dph_12/config/env-params.json",
        required=False
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="environments/slime_dph_12/config/env_visualizer-params.json",
        required=False
    )
