...
def plot(ep, rewards_x_ep, actions_x_ep, ticks, actions_name):
    ...
    df.to_csv("environments/ants_22/metrics_random.csv", sep=',', index=False)
    ...
    fig.tight_layout()
    plt.savefig("environments/ants_22/Avg_Reward_random")
    ...
    plt.plot(x, y, label="mean", marker='x', markersize=.5, linewidth=.5, color='#DC267F')
    fig.tight_layout()
    plt.savefig("environments/ants_22/Avg_Ticks_random")
    ...
    plt.legend()
    plt.savefig("environments/ants_22/Actions_random")
