...
from environments.ants_24.ants import Ants
...
def create_logger(curdir, params, l_params, log_params, train, weights_path=None):
    from agents.utils import logger_2, logger_3 
...
def main(args):
    ...
    if args.render:
        from environments.ants_24.ants import AntsVisualizer
    ...
    if args.train:
        ...
        logger, logger2, train_log_every = create_logger(curdir, params, l_params, log_params, args.train)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--params_path",
        type=str,
        default="environments/ants_24/config/env-params.json",
        required=False
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="environments/ants_24/config/env_visualizer-params.json",
        required=False
    )
