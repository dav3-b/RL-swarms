...
from environments.ants_17.ants import Ants
...
def main(args):
    ...
    if args.render:
        from environments.ants_17.ants import AntsVisualizer
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--params_path",
        type=str,
        default="environments/ants_17/config/env-params.json",
        required=False
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="environments/ants_17/config/env_visualizer-params.json",
        required=False
    )
